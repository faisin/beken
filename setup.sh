...
# 1. download adyetubar_beken.zip dari repo sendiri
...
PACKAGE_NAME="adyetubar_beken.zip"
PACKAGE_URL="${REPO_RAW_BASE}/${PACKAGE_NAME}"

INSTALL_ROOT="/opt/adyetubar"
PACKAGE_DIR="${INSTALL_ROOT}/ady"
PACKAGE_ZIP="${INSTALL_ROOT}/${PACKAGE_NAME}"
...
info "Mengambil ${PACKAGE_NAME} dari faisin/beken..."
...
[[ -s "${tmp_zip}" ]] || die "${PACKAGE_NAME} kosong atau gagal diunduh."
